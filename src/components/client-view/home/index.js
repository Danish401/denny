...
export default function ClientHomeView({ data }) {
  ...
  <motion.div
    ...
    className="w-[200px] h-[250px] relative bg-[#6C2DC7] rounded-lg"
  >
    <div className="w-[200px] h-[250px] top-[10px] left-[-10px] rounded-lg border-[4px] border-[#000000] absolute"></div>
